        ...
        <div class="pt-2 pb-2 px-2 flex justify-between border-b border-gray-300 mb-2 items-center">
          ...
          <form @submit.prevent="ujianStart" v-if="jadwal && jadwal.length > 0">
            <div class="mb-4">
              ...
              <div class="">
                <div class="w-full">
                  <select v-model="data.jadwal_id" @change="checkToken()" class="text-gray-700 w-full pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-300" :readonly="isLoading" :class="{'bg-gray-200' : isLoading}">
            ...
            <div class="mb-4" v-if="active_token">
              ...
              <div class="flex">
                <input type="text" v-model="data.token" class="w-full pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-blue-300" placeholder="Token" required="" :readonly="isLoading">
              </div>
            </div>
            <div class="">
